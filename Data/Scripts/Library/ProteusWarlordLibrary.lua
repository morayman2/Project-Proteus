...
return {
		...
		["GAROS"] = {
			...
			"Imperial_Bantha_II_Skiff_Company", "Imperial_Gaba18_Company", "Hutt_AA_Skiff_Company",
			"GAT", "JX30_Company", "AV7_Company", "TIE_Crawler_Company", "Imperial_TNT_Company",
			"Imperial_AT_TE_Walker_Company", "Tracked_Shield_Disabler_Company"},
			FactionOverride = "Empire",
			FactionOverride2 = "Zsinj_Empire",
