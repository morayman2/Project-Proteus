...
return {
		...
		["NABOO"] = {
			...
			"Imperial_I_Star_Destroyer", "Imperial_II_Star_Destroyer", "Impellor_Carrier", 
			"Compellor_Battlecruiser", "Legator_Star_Dreadnought", "Executor_Star_Dreadnought", "Silverline_Location_Set"},
			LockList = {"GormTalquist_HQ"},
			FactionOverride = "Empire",
		...
		["ZAARIN_REMNANTS"] = {
			...
			FactionOverride = "Empire",
			FactionOverride2 = "Pentastar",
			UnlockList = {"Beta_ETR_3_Group", "Imperial_CR90", "Tartan_Patrol_Cruiser", "CR92A", "Imperial_Nebulon_B", "Ton_Falk_Escort_Carrier", "Strike_Cruiser",
