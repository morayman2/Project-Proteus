...
return {
		...
		["PRENTIOCH"] = {
			...
			UnlockList = {
				...
				"Interdictor_Star_Destroyer", "Imperial_I_Star_Destroyer_Command", "Acclamator_Battleship", "Maelstrom_Battlecruiser", 
		...
		["KAMINO"] = {
			...
			UnlockList = {
				-- Space
				"YZ_775_Freighter_Group", "Raider_I_Corvette", "Raider_II_Corvette", "Lancer_Frigate", "Active_Frigate", "Imperial_Nebulon_B", "Star_Galleon",
				"Alliance_Assault_Frigate_II", "Gladiator_II", "Acclamator_I_Carrier", "Immobilizer_Twin_Well", "Victory_II_Star_Destroyer",
		...
		["TIERFON"] = {
			...
			UnlockList = {
				...
				"Deathhawk_Company", "Imperial_Shadow_LAAT_Company", "AT_AA_Missile_Walker_Company", "SPMAG_Walker_Company", "SPMAT_Company",
				"Imperial_A5_Juggernaut_Company", "Lancet_Air_Artillery_Company",
				-- Structure
				"Tierfon_Shipyard_Capital", 
			},
			LockList = {"Imperial_Proteus_Capital"},
			FactionOverride = "Empire",
			FactionOverride2 = "Zsinj_Empire",
		...
		["TAMARIN"] = {
			...
			"PX10_Company", "AT_ST_Company", "AA70_Company", "INT4_Company", "MAAT_Company",
		...
		["KASHYYYK"] = {
			...
			UnlockList = {"YE_4_Group", "YZ_775_Freighter_Group", "Imperial_CR90", "Ipv1_Gunboat_Proteus", "Proteus_Kaloth", "Interceptor_I_Frigate", "Interceptor_Iv_Frigate", "Tartan_Patrol_Cruiser", "CEC_Light_Cruiser", "Starbolt", "Victory_I_Frigate", "CC700",
			...
			"Imperial_AT_AP_Walker_Company", "Trandoshan_Hunter_Company", "Imperial_Scout_Trooper_Company", "Imperial_Dwarf_Spider_Droid_Company", "Republic_BARC_Company", "Imperial_AT_PT_Company", "Imperial_AT_RT_Company", "AT_KT_Company", "Arrow_23_Company", "Imperial_Light_Mobile_Artillery_Company", "Imperial_TX130T_Company", "Imperial_Dropship_Transport_Company", "AT_AA_Flak_Walker_Company", "Imperial_AT_AT_Walker_Company", "Proteus_A6_Company", "Camo_AT_TE_Walker_Company", "Hssissk_Location_Set",
			-- Structures
			"Pirate_Base"},
		...
		["LUMIYA"] = {
			...
			[11] = {"VT49_Decimator_Group", "Imperial_CR90", "Raider_II_Corvette", "Lancer_Frigate", "Imperial_Nebulon_B", "Strike_Cruiser", "Ton_Falk_Escort_Carrier",
			"Immobilizer_418_Refit", "Gladiator_II", "Proteus_Cargo_Ship", "Imperial_II_Frigate", "Victory_I_Fleet_Star_Destroyer", "Victory_II_Star_Destroyer",
			"Interdictor_Star_Destroyer", "Imperial_I_Star_Destroyer_Carrier", "Imperial_I_Star_Destroyer_Assault", "Imperial_II_Star_Destroyer",
			"Allegiance_Battlecruiser", "Sorannan_Star_Destroyer", "Impellor_Carrier", "Shadow_Vengeance_Star_Dreadnought",
			"Royal_Guard_Stormtrooper_Company", "Imperial_Dark_Jedi_Company_Proteus", "Sith_Knight_Company", "Shadow_EVO_Trooper_Company", "Imperial_74Z_Bike_Company",
		...
		["KAARENTH_DISSENSION"] = {
			...
			HeroList = {"Ennix_Devian_Team", "Ulcane_Dissension", "Makar", "Ree_Shala", "T11"},
			UnlockList = {"Imperial_Boarding_Shuttle", "Delta_JV7_Group", "IPV1_Zeta", "Nebulon_B_Tender", "Carrack_Cruiser_Zeta", "Strike_Cruiser", "Quasar", "Crusader_Gunship_Pirate", "Proteus_Kaloth", "Gladiator_II", "Super_Transport_XI_Missile_Pirate", "Immobilizer_418_Refit", "Hornet_Assault_Carrier", "Neutron_Star_Mercenary", "Victory_I_Star_Destroyer", "Refit_Venator_Star_Destroyer_Proteus", "Dauntless_Transport", "Providence_Carrier_Destroyer_Pirate", "Maelstrom_Battlecruiser", "Imperial_I_Star_Destroyer", "Praetor_Carrier_Battlecruiser", "Bellator_Star_Dreadnought",
		-- Land 
			"Imperial_Army_Guard_Company", "Light_Mercenary_Platoon", "Republic_BARC_Company", "Imperial_AT_PT_Company", "AT_XT_Company", "Gian_Rebel_Company", "008_Speeder_Company", "Imperial_Flashblind_Company", "New_Republic_MPTL_Company", "Imperial_LAAT_Company", "MZ8_Tank_Company", "AT_AI_Walker_Company",
