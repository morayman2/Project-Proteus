...
return {
		["LAMBDA"] = {
			...
			LastYear = 8,
			UnlockList = {"Beta_ETR_3_Group", "IPV1", "Lancer_Frigate", "Surveyor_Frigate", "Ton_Falk_Escort_Carrier", "Star_Galleon", "Strike_Cruiser",
			...
			"Interdictor_Star_Destroyer", "Imperial_I_Star_Destroyer", "Imperial_II_Star_Destroyer", "Allegiance_Battlecruiser",
			"Praetor_II_Battlecruiser", "Executor_Star_Dreadnought",
		...
		["ELROOD"] = {
			...
			UnlockList = {"ISB_Infiltrator_Company", "Imperial_Dark_Jedi_Company_Proteus", "Imperial_Galactic_Marine_Company", "Imperial_Army_74Z_Bike_Company",
		...
		["WILD_SPACE"] = {
			...
			UnlockList = {"Pursuer_Enforcement_Ship_Group", "Action_VI_Refit", "Lancer_Frigate_PDF", "Corellian_Buccaneer", "Strike_Cruiser_Light", "Starbolt", "Super_Transport_VII_Interdictor", 
			...
			"AT_OT_Walker_Company", "Imperial_A4_Juggernaut_Company", "CEC_HQ", "TaggeCo_HQ"},
		...
		["PRENTIOCH"] = {
			...
			UnlockList = {"CSA_Destroyer_Droid_Company", "Imperial_Army_Trooper_Company", "Imperial_Dwarf_Spider_Droid_Company", 
			...
			"C10_Siege_Tower_Company", "Tracked_Mobile_Base_Company", "Rossum_HQ", "Baktoid_HQ", "Mekuun_HQ", "Colicoid_HQ", "Cygnus_HQ",
		...
		["PRAKITH"] = { --Shynne, Voba Dokrett, Ors Dogot, Gegak?
			...
			UnlockList = {"Delta_JV7_Group", "IPV1", "Patrol_Nebulon_B",
			...
			"Arrow_23_Company", "AT_DP_Company", "Imperial_TNT_Company", "Talon_Flamestrike_Cloud_Car_Company",
			"TIE_Crawler_Company", "SPMAT_Company", "AT_AA_Flak_Walker_Company", "Imperial_AT_TE_Walker_Company", "T4A_Company"},
			--LockList = {"Imperial_Army_Guard_Company"},
			FactionOverride = "Empire",
			StartYear = 12,
			LastYear = 18,
		...
		["JARDEEN"] = {
			...
			"Imperial_AT_AT_Walker_Company", "Imperial_AT_TE_Walker_Company", "CEC_HQ",
		...
		["KAMINO"] = {
			...
			UnlockList = {"Navy_Commando_Company", "Incinerator_Stormtrooper_Company", "Imperial_Jumptrooper_Company", "EVO_Trooper_Company", "Dark_Trooper_Phase_II_Company", 
		...
		["NABOO"] = {
			...
			UnlockList = {"Imperial_Army_Trooper_Company", "Imperial_Galactic_Marine_Company", "Dark_Trooper_Phase_II_Company", "Imperial_74Z_Bike_Company",
			...
			"Impellor_Carrier", "Compellor_Battlecruiser", "Legator_Star_Dreadnought", "Executor_Star_Dreadnought", "Silverline_Location_Set"},
			LockList = {"GormTalquist_HQ"},
			FactionOverride = "Empire",
		...
		["TAPANI"] = {
			...
			UnlockList = {"YE_4_Group", "Mansk_Frigate", "Raider_II_Corvette", "Marauder_Cruiser", "Lancer_Frigate", "Patrol_Nebulon_B", "Strike_Cruiser", "Star_Galleon", "Tapani_Assault_Frigate", 
		...
		["PROPHETS"] = {
			...
			UnlockList = {"PDF_Force_Cultist_Company", "Imperial_Army_Guard_Company", "Imperial_Dark_Jedi_Company_Proteus", "Terentatek_Company",
		...
		["TAGGE"] = {
			...
			"1M_Tank_Company", "AT_AA_Flak_Walker_Company", "JX40_Company", "Imperial_Missile_Artillery_Company", "SPMAT_Company", "Strikebreaker_Company", "Teklos_Company",},
			FactionOverride = "Empire",
			FactionOverride2 = "Zsinj_Empire",
		...
		["TIERFON"] = {
			...
			UnlockList = {"Beta_ETR_3_Group", "Raider_I_Corvette", "Raider_II_Corvette", "Tartan_Patrol_Cruiser", "Eidolon", 
		...
		["BAKURA"] = {
			...
			UnlockList = {"Gamma_ATR_6_Group", "IPV1", "Imperial_DP20", "Carrack_Cruiser", "Patrol_Nebulon_B", "Star_Galleon", "Super_Transport_VII_Interdictor", "Namana_Cruiser_Proteus",
		...
		["ISECTOR"] = {
			...
			UnlockList = {"YZ_775_Freighter_Group", "IPV1", "Patrol_Nebulon_B", "Galleon", "Strike_Cruiser_Light",
		...
		["QUINTAD"] = {
			...
			UnlockList = {"Gozanti_Cruiser_Group", "LAC", "Charger_C70", "CEC_Light_Cruiser", "Carrack_Cruiser", "Galleon", "Starbolt",
		...
		["DASTA"] = {
			...
			UnlockList = {"Guardian_Cruiser_Group", "Imperial_CR90", "Action_VI_Support", "Marauder_Cruiser", "Quasar", "Star_Galleon",
			...
			"Yarnar_Location_Set", "Dasta_TradeStation"},
		...
		["HAMMERS"] = {
			...
			UnlockList = {"Beta_ETR_3_Group", "IPV1", "Lancer_Frigate", "Carrack_Cruiser", "Ton_Falk_Escort_Carrier", "Star_Galleon", "Strike_Cruiser",
			...
			"Interdictor_Star_Destroyer", "Imperial_I_Star_Destroyer_Command", "Imperial_II_Star_Destroyer", "Allegiance_Battlecruiser", "Torpedo_Sphere",
			"Executor_Star_Dreadnought",
		...
		["SELLASAS"] = {
			...
			UnlockList = {"Customs_Corvette", "Consular_Refit", "Tartan_Patrol_Cruiser", "Pelta_Support", "Carrack_Cruiser", "Ton_Falk_Escort_Carrier", "Strike_Interdictor",
			...
			"Yutrane_Trackata_HQ", "Sellasas_Loadout_Swap1"},
		...
		["PROTECTORATE"] = {
			...
			UnlockList = {"Customs_Corvette", "Guardian_Cruiser_Group", "Tartan_Patrol_Cruiser", "Vigil", "Carrack_Cruiser", "Star_Galleon", "Strike_Cruiser", "Strike_Interdictor", 
			"Pursuit_Light_Cruiser", "Vindicator_Cruiser", "Broadside_Cruiser", "Imperial_II_Frigate", "Victory_I_Star_Destroyer", "Victory_II_Star_Destroyer", "Interdictor_Star_Destroyer", "Imperial_I_Star_Destroyer", "Imperial_I_Star_Destroyer_Carrier", "Secutor_Star_Destroyer", "Mandator_III_Dreadnought",
			"Imperial_Army_Trooper_Company", "Navy_Commando_Company", "Light_Mercenary_Company", "Imperial_Army_74Z_Bike_Company", "Imperial_AT_RT_Company", "Imperial_ISP_Company", "RTT_Company", "INT4_Company",
		...
		["ZAARIN_REMNANTS"] = {
			...
			FactionOverride = "Empire",
			FactionOverride2 = "Pentastar",
			UnlockList = {"Beta_ETR_3_Group", "Imperial_CR90", "Tartan_Patrol_Cruiser", "CR92A", "Imperial_Nebulon_B", "Ton_Falk_Escort_Carrier", "Strike_Cruiser", "Star_Galleon",
		...
		["VOGEL"] = {
			...
			UnlockList = {"Gamma_ATR_6_Group", "Action_VI_Refit", "Tartan_Patrol_Cruiser", "Active_Frigate", "Victory_II_Frigate", 
		...
		["RESTORED_EMPIRE"] = {
			...
			UnlockList = {"Imperial_CR90", "Charger_C70", "Carrack_Cruiser_Laser",  "Arquitens", "Galleon_Minelayer", "Pelta_Assault", "Pelta_Support", "Rep_DHC",
			...
			"Imperial_TX130S_Company", "AV_7_Company", "Imperial_LAAT_Company", "Imperial_AT_AP_Walker_Company",
