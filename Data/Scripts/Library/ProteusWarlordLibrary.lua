...
return {
		...
		["RADAMA"] = {
			...
			UnlockList = {"Citadel_Cruiser_Group", "IPV1", "Charger_C70", "Diamond_Frigate", "Marauder_Cruiser", "Carrack_Cruiser", "Ton_Falk_Escort_Carrier",
		...
		["MAELSTROM"] = {
			...
			UnlockList = {"VT49_Decimator_Group", "Raider_I_Corvette", "CR92A", "Tartan_Patrol_Cruiser", "Vigil", "Carrack_Cruiser", "Galleon", "Strike_Cruiser",
		...
		["ISECTOR"] = {
			...
			UnlockList = {
				...
				"PDF_DHC", "Battle_Horn", "Acclamator_Patrol_Refit", "Immobilizer_418", "Acclamator_I_Support", "Victory_I_Star_Destroyer",
		...
		["DASTA"] = {
			...
			UnlockList = {
				...
				"Super_Transport_VI", "Super_Transport_VII_Missile", "PDF_DHC", "Neutron_Star", "Captor_Cruiser", "Immobilizer_418", "Super_Transport_XI_Modified", "Victory_I_Star_Destroyer",
		...
		["KASHYYYK"] = {
			...
			HeroList = {"Krieg_Immobilizer", "Syn_Silooth", "Darcc_Team", "Pekt_Team", "Merili_Team"},
		...
		["LUMIYA"] = {
			...
			HeroList = {{"Lumiya_Team", "Bethrogg_Behemoth", "Valek_Revenant", "Carnor_Jax_Proteus_Team"}, [10] = {"Lumiya_Team", "Bethrogg_Behemoth", "Valek_Revenant"}},
		...
		["ARDA"] = {
			...
			"Imperial_AT_AT_Walker_Company", "Tracked_Shield_Disabler_Company", "SoroSuub_HQ", "Mekuun_HQ", "Taim_Bak_HQ", "TAM_BLACKSTAR_DARK_BLADE_LOCATION_SET",
		...
		["RAYTER"] = {
			...
			UnlockList = {"Gamma_ATR_6_Group", "IPV1", "Lancer_Frigate", "Carrack_Cruiser", "CEC_Light_Cruiser", "Strike_Cruiser", "Star_Galleon",
		...
		["WESSEX"] = {
			...
			UnlockList = {"Guardian_Cruiser_Group", "Raider_I_Corvette", "Raider_II_Corvette", "Victory_II_Frigate", "Arquitens", "Strike_Cruiser",
			...
			"Imperial_ISP_Company", "RTT_Company", "Chariot_LAV_Company", "AT_ST_Company", "Imperial_TX130S_Company", "Imperial_Heavy_Mobile_Artillery_Company", "Imperial_AT_AP_Walker_Company", "Imperial_VAAT_Company", "AT_AA_Walker_Company", 
